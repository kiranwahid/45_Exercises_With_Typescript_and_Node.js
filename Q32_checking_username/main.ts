...
let current_users:string[] = ['RaHeel','AzLan','TaHa','ZaIn','ShaMeer'];

// array of new_user...

let new_users:string[] = ['Sarim','ShaMeer','Sufyan','Azlan','Haris']


new_users.forEach(newUser => {
    let lowercase:string = newUser.toLocaleLowerCase()
